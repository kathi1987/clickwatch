...
public class TestUtil {
	...
	@Singleton
	public static class ClickSocketWrapper extends ClickWatchServerSocketPlayerSocket {
		private ClickWatchServerSocketPlayerSocket source;
		
		public void setSource(ClickWatchServerSocketPlayerSocket source) {
			this.source = source;
		}
	...
	public static ClickWatchServerSocketPlayerSocket createClickSocket(final int numberOfElements, final int numberOfHandlers, final boolean isChanging) {
		return new ClickWatchServerSocketPlayerSocket() {	
			int change = 0;
