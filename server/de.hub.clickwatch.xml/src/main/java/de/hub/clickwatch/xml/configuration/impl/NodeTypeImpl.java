 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.xml.configuration.impl.NodeTypeImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link de.hub.clickwatch.xml.configuration.impl.NodeTypeImpl#getElementFilter <em>Element Filter</em>}</li>
 *   <li>{@link de.hub.clickwatch.xml.configuration.impl.NodeTypeImpl#getHandlerFilter <em>Handler Filter</em>}</li>
 *   <li>{@link de.hub.clickwatch.xml.configuration.impl.NodeTypeImpl#getPort <em>Port</em>}</li>
 *   <li>{@link de.hub.clickwatch.xml.configuration.impl.NodeTypeImpl#getProtocol <em>Protocol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
