...
public class ConfigurationAdapterFactory extends AdapterFactoryImpl {
	...
	protected ConfigurationSwitch<Adapter> modelSwitch =
		new ConfigurationSwitch<Adapter>() {
			...
			@Override
			public Adapter caseExperimentListType(ExperimentListType object) {
				return createExperimentListTypeAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseHandlerListType(HandlerListType object) {
				return createHandlerListTypeAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseNodeListType(NodeListType object) {
				return createNodeListTypeAdapter();
			}
			@Override
