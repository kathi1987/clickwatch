 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.xml.impl.ConfigurationTypeImpl#getNetwork <em>Network</em>}</li>
 *   <li>{@link de.hub.clickwatch.xml.impl.ConfigurationTypeImpl#getCdo <em>Cdo</em>}</li>
 *   <li>{@link de.hub.clickwatch.xml.impl.ConfigurationTypeImpl#getLogDirectory <em>Log Directory</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConfigurationTypeImpl extends EObjectImpl implements ConfigurationType {
	...
	protected EClass eStaticClass() {
		return de.hub.clickwatch.xml.ConfigurationPackage.Literals.CONFIGURATION_TYPE;
	}
