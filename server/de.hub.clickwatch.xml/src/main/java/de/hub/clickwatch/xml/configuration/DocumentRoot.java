 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.xml.configuration.DocumentRoot#getMixed <em>Mixed</em>}</li>
 *   <li>{@link de.hub.clickwatch.xml.configuration.DocumentRoot#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link de.hub.clickwatch.xml.configuration.DocumentRoot#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link de.hub.clickwatch.xml.configuration.DocumentRoot#getConfiguration <em>Configuration</em>}</li>
 * </ul>
 * </p>
 *
...
public interface DocumentRoot extends EObject {
	...
	/**
	 * Sets the value of the '{@link de.hub.clickwatch.xml.configuration.DocumentRoot#getConfiguration <em>Configuration</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
