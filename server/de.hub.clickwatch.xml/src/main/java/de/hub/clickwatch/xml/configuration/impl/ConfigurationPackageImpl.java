...
import de.hub.clickwatch.xml.configuration.util.ConfigurationValidator;
...
public class ConfigurationPackageImpl extends EPackageImpl implements ConfigurationPackage {
	 ...
	 * @see de.hub.clickwatch.xml.configuration.ConfigurationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getConfigurationType_Database() {
	...
	public void createPackageContents() {
		...
		createEReference(configurationTypeEClass, CONFIGURATION_TYPE__DATABASE);
	...
	public void initializePackageContents() {
		...
		initEReference(getConfigurationType_Database(), this.getDatabaseType(), null, "database", null, 1, -1, ConfigurationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
