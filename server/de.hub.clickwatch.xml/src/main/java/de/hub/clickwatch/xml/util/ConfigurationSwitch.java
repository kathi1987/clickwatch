...
public class ConfigurationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ConfigurationPackage.EXPERIMENT_LIST_TYPE: {
				ExperimentListType experimentListType = (ExperimentListType)theEObject;
				T result = caseExperimentListType(experimentListType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ConfigurationPackage.HANDLER_LIST_TYPE: {
				HandlerListType handlerListType = (HandlerListType)theEObject;
				T result = caseHandlerListType(handlerListType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ConfigurationPackage.NODE_LIST_TYPE: {
				NodeListType nodeListType = (NodeListType)theEObject;
				T result = caseNodeListType(nodeListType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Experiment List Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Experiment List Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExperimentListType(ExperimentListType object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Handler List Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Handler List Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHandlerListType(HandlerListType object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Node List Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Node List Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNodeListType(NodeListType object) {
		return null;
	}
