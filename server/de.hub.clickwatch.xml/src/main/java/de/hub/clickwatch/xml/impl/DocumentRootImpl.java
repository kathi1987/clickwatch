 ...
 *   <li>{@link de.hub.clickwatch.xml.impl.DocumentRootImpl#getConfiguration <em>Configuration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
	...
	public ConfigurationType getConfiguration() {
		return (ConfigurationType)getMixed().get(de.hub.clickwatch.xml.ConfigurationPackage.Literals.DOCUMENT_ROOT__CONFIGURATION, true);
	}
	...
	public NotificationChain basicSetConfiguration(ConfigurationType newConfiguration, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(de.hub.clickwatch.xml.ConfigurationPackage.Literals.DOCUMENT_ROOT__CONFIGURATION, newConfiguration, msgs);
	}
	...
	public void setConfiguration(ConfigurationType newConfiguration) {
		((FeatureMap.Internal)getMixed()).set(de.hub.clickwatch.xml.ConfigurationPackage.Literals.DOCUMENT_ROOT__CONFIGURATION, newConfiguration);
	}
