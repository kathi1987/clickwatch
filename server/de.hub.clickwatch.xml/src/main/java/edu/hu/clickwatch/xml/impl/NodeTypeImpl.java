...
import edu.hu.clickwatch.xml.ProtocolType;
 ...
 * <ul>
 *   <li>{@link edu.hu.clickwatch.xml.impl.NodeTypeImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link edu.hu.clickwatch.xml.impl.NodeTypeImpl#getElementFilter <em>Element Filter</em>}</li>
 *   <li>{@link edu.hu.clickwatch.xml.impl.NodeTypeImpl#getHandlerFilter <em>Handler Filter</em>}</li>
 *   <li>{@link edu.hu.clickwatch.xml.impl.NodeTypeImpl#getPort <em>Port</em>}</li>
 *   <li>{@link edu.hu.clickwatch.xml.impl.NodeTypeImpl#getProtocol <em>Protocol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NodeTypeImpl extends EObjectImpl implements NodeType {
	...
	protected EClass eStaticClass() {
		return edu.hu.clickwatch.xml.ConfigurationPackage.Literals.NODE_TYPE;
	}
