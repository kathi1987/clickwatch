...
public class ConfigurationFactoryImpl extends EFactoryImpl implements ConfigurationFactory {
	...
	public static ConfigurationFactory init() {
		try {
			ConfigurationFactory theConfigurationFactory = (ConfigurationFactory)EPackage.Registry.INSTANCE.getEFactory("platform:/resource/edu.hu.clickwatch.xml/src/main/resources/configuration.xsd"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ConfigurationPackage.CDO_TYPE: return createCdoType();
	...
	public ProtocolType createProtocolTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createProtocolTypeFromString(edu.hu.clickwatch.xml.ConfigurationPackage.Literals.PROTOCOL_TYPE, initialValue);
	}
	...
	public String convertProtocolTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertProtocolTypeToString(edu.hu.clickwatch.xml.ConfigurationPackage.Literals.PROTOCOL_TYPE, instanceValue);
	}
