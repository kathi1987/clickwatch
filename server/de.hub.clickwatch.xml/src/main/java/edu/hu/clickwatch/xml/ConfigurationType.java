 ...
 * <ul>
 *   <li>{@link edu.hu.clickwatch.xml.ConfigurationType#getNetwork <em>Network</em>}</li>
 *   <li>{@link edu.hu.clickwatch.xml.ConfigurationType#getCdo <em>Cdo</em>}</li>
 *   <li>{@link edu.hu.clickwatch.xml.ConfigurationType#getLogDirectory <em>Log Directory</em>}</li>
 * </ul>
 * </p>
 *
 * @see edu.hu.clickwatch.xml.ConfigurationPackage#getConfigurationType()
...
public interface ConfigurationType extends EObject {
	 ...
	 * @see edu.hu.clickwatch.xml.ConfigurationPackage#getConfigurationType_Network()
	 ...
	 * The list contents are of type {@link edu.hu.clickwatch.xml.CdoType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see edu.hu.clickwatch.xml.ConfigurationPackage#getConfigurationType_Cdo()
	 * @model containment="true" required="true"
	 ...
	 * @see edu.hu.clickwatch.xml.ConfigurationPackage#getConfigurationType_LogDirectory()
	...
	/**
	 * Sets the value of the '{@link edu.hu.clickwatch.xml.ConfigurationType#getLogDirectory <em>Log Directory</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
