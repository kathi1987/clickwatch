 ...
 * <ul>
 *   <li>{@link edu.hu.clickwatch.xml.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link edu.hu.clickwatch.xml.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link edu.hu.clickwatch.xml.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link edu.hu.clickwatch.xml.impl.DocumentRootImpl#getConfiguration <em>Configuration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
	...
	protected EClass eStaticClass() {
		return edu.hu.clickwatch.xml.ConfigurationPackage.Literals.DOCUMENT_ROOT;
	}
	...
	public ConfigurationType getConfiguration() {
		return (ConfigurationType)getMixed().get(edu.hu.clickwatch.xml.ConfigurationPackage.Literals.DOCUMENT_ROOT__CONFIGURATION, true);
	}
	...
	public NotificationChain basicSetConfiguration(ConfigurationType newConfiguration, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(edu.hu.clickwatch.xml.ConfigurationPackage.Literals.DOCUMENT_ROOT__CONFIGURATION, newConfiguration, msgs);
	}
	...
	public void setConfiguration(ConfigurationType newConfiguration) {
		((FeatureMap.Internal)getMixed()).set(edu.hu.clickwatch.xml.ConfigurationPackage.Literals.DOCUMENT_ROOT__CONFIGURATION, newConfiguration);
	}
