 ...
 * $Id$
 */
package edu.hu.clickwatch.xml.util;
...
import edu.hu.clickwatch.xml.*;

/**
 * <!-- begin-user-doc -->
 * The <b>Validator</b> for the model.
 * <!-- end-user-doc -->
 * @see edu.hu.clickwatch.xml.ConfigurationPackage
 * @generated
 */
public class ConfigurationValidator extends EObjectValidator {
	...
	public boolean validateAddressType_Pattern(String addressType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(edu.hu.clickwatch.xml.ConfigurationPackage.Literals.ADDRESS_TYPE, addressType, ADDRESS_TYPE__PATTERN__VALUES, diagnostics, context);
	}
	...
	public boolean validatePortType_Min(BigInteger portType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMinViolation(edu.hu.clickwatch.xml.ConfigurationPackage.Literals.PORT_TYPE, portType, PORT_TYPE__MIN__VALUE, true, diagnostics, context);
		return result;
	}
	...
	public boolean validatePortType_Max(BigInteger portType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMaxViolation(edu.hu.clickwatch.xml.ConfigurationPackage.Literals.PORT_TYPE, portType, PORT_TYPE__MAX__VALUE, true, diagnostics, context);
		return result;
	}
