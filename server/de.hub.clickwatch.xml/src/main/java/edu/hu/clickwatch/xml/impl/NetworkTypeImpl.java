 ...
 * <ul>
 *   <li>{@link edu.hu.clickwatch.xml.impl.NetworkTypeImpl#getNode <em>Node</em>}</li>
 *   <li>{@link edu.hu.clickwatch.xml.impl.NetworkTypeImpl#getNetwork <em>Network</em>}</li>
 *   <li>{@link edu.hu.clickwatch.xml.impl.NetworkTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link edu.hu.clickwatch.xml.impl.NetworkTypeImpl#getUpdateInterval <em>Update Interval</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NetworkTypeImpl extends EObjectImpl implements NetworkType {
	...
	protected EClass eStaticClass() {
		return edu.hu.clickwatch.xml.ConfigurationPackage.Literals.NETWORK_TYPE;
	}
