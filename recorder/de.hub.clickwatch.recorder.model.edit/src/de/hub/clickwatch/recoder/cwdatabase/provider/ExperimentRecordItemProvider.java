 ...
 * @generated
 */
public class ExperimentRecordItemProvider
	 ...
	 * @generated
	 */
	public ExperimentRecordItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExperimentRecord_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExperimentRecord_name_feature", "_UI_ExperimentRecord_type"),
				 CWDataBasePackage.Literals.EXPERIMENT_RECORD__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns ExperimentRecord.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExperimentRecord"));
	}
	...
	public String getText(Object object) {
		String label = ((ExperimentRecord)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ExperimentRecord_type") :
			getString("_UI_ExperimentRecord_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ExperimentRecord.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CWDataBasePackage.Literals.EXPERIMENT_RECORD__NODE_MAP,
				 CWDataBaseFactory.eINSTANCE.create(CWDataBasePackage.Literals.ESTRING_TO_EXPERIMENT_NODE_RECORD_TIME_TABLE_MAP)));
	}
