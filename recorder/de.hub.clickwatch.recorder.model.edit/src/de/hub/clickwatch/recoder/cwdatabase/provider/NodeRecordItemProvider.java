...
/**
 * This is the item provider adapter for a {@link de.hub.clickwatch.recoder.cwdatabase.NodeRecord} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NodeRecord_start_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NodeRecord_start_feature", "_UI_NodeRecord_type"),
				 CWDataBasePackage.Literals.NODE_RECORD__START,
				 true,
				 false,
				 false,
	...
	protected void addEndPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NodeRecord_end_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NodeRecord_end_feature", "_UI_NodeRecord_type"),
				 CWDataBasePackage.Literals.NODE_RECORD__END,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
