 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.recoder.cwdatabase.impl.RecordStatisticsImpl#getNodesA <em>Nodes A</em>}</li>
 *   <li>{@link de.hub.clickwatch.recoder.cwdatabase.impl.RecordStatisticsImpl#getSamplesN <em>Samples N</em>}</li>
 *   <li>{@link de.hub.clickwatch.recoder.cwdatabase.impl.RecordStatisticsImpl#getHandlersN <em>Handlers N</em>}</li>
 *   <li>{@link de.hub.clickwatch.recoder.cwdatabase.impl.RecordStatisticsImpl#getHandlersPulledS <em>Handlers Pulled S</em>}</li>
 *   <li>{@link de.hub.clickwatch.recoder.cwdatabase.impl.RecordStatisticsImpl#getHandlersR <em>Handlers R</em>}</li>
 *   <li>{@link de.hub.clickwatch.recoder.cwdatabase.impl.RecordStatisticsImpl#getTimeA <em>Time A</em>}</li>
 *   <li>{@link de.hub.clickwatch.recoder.cwdatabase.impl.RecordStatisticsImpl#getTimeN <em>Time N</em>}</li>
 *   <li>{@link de.hub.clickwatch.recoder.cwdatabase.impl.RecordStatisticsImpl#getTimeS <em>Time S</em>}</li>
 *   <li>{@link de.hub.clickwatch.recoder.cwdatabase.impl.RecordStatisticsImpl#getSamplesPerSecond <em>Samples Per Second</em>}</li>
 *   <li>{@link de.hub.clickwatch.recoder.cwdatabase.impl.RecordStatisticsImpl#getRecordSize <em>Record Size</em>}</li>
 *   <li>{@link de.hub.clickwatch.recoder.cwdatabase.impl.RecordStatisticsImpl#getSamplesR <em>Samples R</em>}</li>
 *   <li>{@link de.hub.clickwatch.recoder.cwdatabase.impl.RecordStatisticsImpl#getBytesRequestS <em>Bytes Request S</em>}</li>
 *   <li>{@link de.hub.clickwatch.recoder.cwdatabase.impl.RecordStatisticsImpl#getTimeRequestS <em>Time Request S</em>}</li>
 *   <li>{@link de.hub.clickwatch.recoder.cwdatabase.impl.RecordStatisticsImpl#getCpuLoadS <em>Cpu Load S</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
