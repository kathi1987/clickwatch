...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object ' <em><b>de.hub.clickwatch.recoder.cwdatabase.NodeRecord</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class NodeRecordBuilder implements de.hub.clickwatch.recoder.cwdatabase.util.builder.ICwdatabaseBuilder<de.hub.clickwatch.recoder.cwdatabase.NodeRecord> {
  ...
  /**
   * This method constructs the final de.hub.clickwatch.recoder.cwdatabase.NodeRecord type.
   * @return new instance of the de.hub.clickwatch.recoder.cwdatabase.NodeRecord type
   */
  public de.hub.clickwatch.recoder.cwdatabase.NodeRecord build() {
    final de.hub.clickwatch.recoder.cwdatabase.NodeRecord _newInstance = de.hub.clickwatch.recoder.cwdatabase.CWDataBaseFactory.eINSTANCE.createNodeRecord();
    if (m_featureEndSet) {
