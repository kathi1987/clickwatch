 ...
 * @generated
 */
public class RecordStatisticsBuilder implements de.hub.clickwatch.recoder.cwdatabase.util.builder.ICwdatabaseBuilder<de.hub.clickwatch.recoder.cwdatabase.RecordStatistics> {
   ...
   */
  public de.hub.clickwatch.recoder.cwdatabase.RecordStatistics build() {
    final de.hub.clickwatch.recoder.cwdatabase.RecordStatistics _newInstance = de.hub.clickwatch.recoder.cwdatabase.CWDataBaseFactory.eINSTANCE.createRecordStatistics();
