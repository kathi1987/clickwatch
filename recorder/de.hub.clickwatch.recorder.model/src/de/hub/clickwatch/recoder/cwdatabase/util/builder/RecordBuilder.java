 ...
 * @generated
 */
public class RecordBuilder implements de.hub.clickwatch.recoder.cwdatabase.util.builder.ICwdatabaseBuilder<de.hub.clickwatch.recoder.cwdatabase.Record> {
  ...
  private de.hub.clickwatch.recoder.cwdatabase.RecordStatistics m_statistics;
  private de.hub.clickwatch.recoder.cwdatabase.util.builder.ICwdatabaseBuilder<? extends de.hub.clickwatch.recoder.cwdatabase.RecordStatistics> m_featureStatisticsBuilder;
   ...
   */
  public de.hub.clickwatch.recoder.cwdatabase.Record build() {
    final de.hub.clickwatch.recoder.cwdatabase.Record _newInstance = de.hub.clickwatch.recoder.cwdatabase.CWDataBaseFactory.eINSTANCE.createRecord();
  ...
  public RecordBuilder withDataBase(de.hub.clickwatch.recoder.cwdatabase.DataBase p_dataBase) {
    m_dataBase = p_dataBase;
    m_featureDataBaseSet = true;
    return this;
  }

  public RecordBuilder withDataBase(de.hub.clickwatch.recoder.cwdatabase.util.builder.ICwdatabaseBuilder<? extends de.hub.clickwatch.recoder.cwdatabase.DataBase> p_dataBaseBuilder) {
  ...
  public RecordBuilder withHBaseRowMap(de.hub.clickwatch.recoder.cwdatabase.HBaseRowMap p_hBaseRowMap) {
  ...
  public RecordBuilder withStatistics(de.hub.clickwatch.recoder.cwdatabase.RecordStatistics p_statistics) {
    m_statistics = p_statistics;
    m_featureStatisticsSet = true;
    return this;
  }

  public RecordBuilder withStatistics(de.hub.clickwatch.recoder.cwdatabase.util.builder.ICwdatabaseBuilder<? extends de.hub.clickwatch.recoder.cwdatabase.RecordStatistics> p_recordStatisticsBuilder) {
