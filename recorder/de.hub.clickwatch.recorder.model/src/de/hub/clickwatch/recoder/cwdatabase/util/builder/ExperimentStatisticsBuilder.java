...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object ' <em><b>de.hub.clickwatch.recoder.cwdatabase.ExperimentStatistics</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class ExperimentStatisticsBuilder implements de.hub.clickwatch.recoder.cwdatabase.util.builder.ICwdatabaseBuilder<de.hub.clickwatch.recoder.cwdatabase.ExperimentStatistics> {
  ...
  /**
   * This method constructs the final de.hub.clickwatch.recoder.cwdatabase.ExperimentStatistics type.
   * @return new instance of the de.hub.clickwatch.recoder.cwdatabase.ExperimentStatistics type
   */
  public de.hub.clickwatch.recoder.cwdatabase.ExperimentStatistics build() {
    final de.hub.clickwatch.recoder.cwdatabase.ExperimentStatistics _newInstance = de.hub.clickwatch.recoder.cwdatabase.CWDataBaseFactory.eINSTANCE.createExperimentStatistics();
