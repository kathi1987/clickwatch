package de.hub.clickwatch.recorder.testv2;
...
import de.hub.clickwatch.recorder.database.cwdatabase.util.builder.CwdatabaseBuilders;
import de.hub.clickwatch.recorder.v2.HBaseDataBaseAdapter;
import de.hub.clickwatch.recorder.v2.IDataBaseAdapter;
import de.hub.clickwatch.recorder.v2.Recorder;
...
public class RecorderTest extends ClickwatchTest {
    ...
    public void testRecorder() throws Exception {
        ...
        Record record = CwdatabaseBuilders.newRecordBuilder()
                .withName("test")
                .withConfiguration(
