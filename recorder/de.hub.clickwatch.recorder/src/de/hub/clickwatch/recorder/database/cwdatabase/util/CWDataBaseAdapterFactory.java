 ...
 * $Id$
 */
package de.hub.clickwatch.recorder.database.cwdatabase.util;
 ...
 * <!-- end-user-doc -->
 * @see de.hub.clickwatch.recorder.database.cwdatabase.CWDataBasePackage
 * @generated
 */
public class CWDataBaseAdapterFactory extends AdapterFactoryImpl {
	...
	protected CWDataBaseSwitch<Adapter> modelSwitch =
		new CWDataBaseSwitch<Adapter>() {
			...
			@Override
			public Adapter caseRecordStatistics(RecordStatistics object) {
				return createRecordStatisticsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hub.clickwatch.recorder.database.cwdatabase.Record <em>Record</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hub.clickwatch.recorder.database.cwdatabase.DataBase <em>Data Base</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hub.clickwatch.recorder.database.cwdatabase.RecordStatistics <em>Record Statistics</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
