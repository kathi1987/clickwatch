...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Record Statistics</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.hub.clickwatch.recorder.database.cwdatabase.impl.RecordStatisticsImpl#getNodesA <em>Nodes A</em>}</li>
 *   <li>{@link de.hub.clickwatch.recorder.database.cwdatabase.impl.RecordStatisticsImpl#getSamplesN <em>Samples N</em>}</li>
 *   <li>{@link de.hub.clickwatch.recorder.database.cwdatabase.impl.RecordStatisticsImpl#getHandlersN <em>Handlers N</em>}</li>
 *   <li>{@link de.hub.clickwatch.recorder.database.cwdatabase.impl.RecordStatisticsImpl#getHandlersPulledS <em>Handlers Pulled S</em>}</li>
 *   <li>{@link de.hub.clickwatch.recorder.database.cwdatabase.impl.RecordStatisticsImpl#getHandlersR <em>Handlers R</em>}</li>
 *   <li>{@link de.hub.clickwatch.recorder.database.cwdatabase.impl.RecordStatisticsImpl#getTimeA <em>Time A</em>}</li>
 *   <li>{@link de.hub.clickwatch.recorder.database.cwdatabase.impl.RecordStatisticsImpl#getTimeN <em>Time N</em>}</li>
 *   <li>{@link de.hub.clickwatch.recorder.database.cwdatabase.impl.RecordStatisticsImpl#getTimeS <em>Time S</em>}</li>
 *   <li>{@link de.hub.clickwatch.recorder.database.cwdatabase.impl.RecordStatisticsImpl#getSamplesPerSecond <em>Samples Per Second</em>}</li>
 *   <li>{@link de.hub.clickwatch.recorder.database.cwdatabase.impl.RecordStatisticsImpl#getRecordSize <em>Record Size</em>}</li>
 *   <li>{@link de.hub.clickwatch.recorder.database.cwdatabase.impl.RecordStatisticsImpl#getSamplesR <em>Samples R</em>}</li>
 *   <li>{@link de.hub.clickwatch.recorder.database.cwdatabase.impl.RecordStatisticsImpl#getBytesRequestS <em>Bytes Request S</em>}</li>
 *   <li>{@link de.hub.clickwatch.recorder.database.cwdatabase.impl.RecordStatisticsImpl#getTimeRequestS <em>Time Request S</em>}</li>
 *   <li>{@link de.hub.clickwatch.recorder.database.cwdatabase.impl.RecordStatisticsImpl#getCpuLoadS <em>Cpu Load S</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RecordStatisticsImpl extends EObjectImpl implements RecordStatistics {
	/**
	...
	/**
	 * The default value of the '{@link #getBytesRequestS() <em>Bytes Request S</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final SummaryStatistics BYTES_REQUEST_S_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getBytesRequestS() <em>Bytes Request S</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getBytesRequestS()
	 * @generated
	 * @ordered
	 */
	protected SummaryStatistics bytesRequestS = BYTES_REQUEST_S_EDEFAULT;

	/**
	 * The default value of the '{@link #getTimeRequestS() <em>Time Request S</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTimeRequestS()
	 * @generated
	 * @ordered
	 */
	protected static final SummaryStatistics TIME_REQUEST_S_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getTimeRequestS() <em>Time Request S</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTimeRequestS()
	 * @generated
	 * @ordered
	 */
	protected SummaryStatistics timeRequestS = TIME_REQUEST_S_EDEFAULT;

	/**
	 * The default value of the '{@link #getCpuLoadS() <em>Cpu Load S</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCpuLoadS()
	 * @generated
	 * @ordered
	 */
	protected static final SummaryStatistics CPU_LOAD_S_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getCpuLoadS() <em>Cpu Load S</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCpuLoadS()
	 * @generated
	 * @ordered
	 */
	protected SummaryStatistics cpuLoadS = CPU_LOAD_S_EDEFAULT;
	 ...
	 * @generated NOT
	 */
	protected RecordStatisticsImpl() {
		super();
	...
	private void initializeStatistics() {
		...
		bytesRequestS = new SynchronizedSummaryStatistics();
		timeRequestS = new SynchronizedSummaryStatistics();
		cpuLoadS = new SynchronizedSummaryStatistics();
	}
	...
	protected EClass eStaticClass() {
		return CWDataBasePackage.Literals.RECORD_STATISTICS;
	}
	...
	public void setNodesA(SummaryStatistics newNodesA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CWDataBasePackage.RECORD_STATISTICS__NODES_A, oldNodesA, nodesA));
	}
	...
	public void setSamplesN(SummaryStatistics newSamplesN) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CWDataBasePackage.RECORD_STATISTICS__SAMPLES_N, oldSamplesN, samplesN));
	}
	...
	public void setHandlersN(SummaryStatistics newHandlersN) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CWDataBasePackage.RECORD_STATISTICS__HANDLERS_N, oldHandlersN, handlersN));
	}
	...
	public void setHandlersPulledS(SummaryStatistics newHandlersPulledS) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CWDataBasePackage.RECORD_STATISTICS__HANDLERS_PULLED_S, oldHandlersPulledS, handlersPulledS));
	}
	...
	public void setHandlersR(SummaryStatistics newHandlersR) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CWDataBasePackage.RECORD_STATISTICS__HANDLERS_R, oldHandlersR, handlersR));
	}
	...
	public void setTimeA(SummaryStatistics newTimeA) {
		...
		timeA = newTimeA;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CWDataBasePackage.RECORD_STATISTICS__TIME_A, oldTimeA, timeA));
	}
	...
	public void setTimeN(SummaryStatistics newTimeN) {
		...
		timeN = newTimeN;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CWDataBasePackage.RECORD_STATISTICS__TIME_N, oldTimeN, timeN));
	}
	...
	public void setTimeS(SummaryStatistics newTimeS) {
		...
		timeS = newTimeS;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CWDataBasePackage.RECORD_STATISTICS__TIME_S, oldTimeS, timeS));
	}
	...
	public void setSamplesPerSecond(double newSamplesPerSecond) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CWDataBasePackage.RECORD_STATISTICS__SAMPLES_PER_SECOND, oldSamplesPerSecond, samplesPerSecond, !oldSamplesPerSecondESet));
	}
	...
	public void unsetSamplesPerSecond() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CWDataBasePackage.RECORD_STATISTICS__SAMPLES_PER_SECOND, oldSamplesPerSecond, SAMPLES_PER_SECOND_EDEFAULT, oldSamplesPerSecondESet));
	}
	...
	public void setRecordSize(SummaryStatistics newRecordSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CWDataBasePackage.RECORD_STATISTICS__RECORD_SIZE, oldRecordSize, recordSize));
	}
	...
	public void setSamplesR(SummaryStatistics newSamplesR) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CWDataBasePackage.RECORD_STATISTICS__SAMPLES_R, oldSamplesR, samplesR));
	}
	 ...
	 * @generated
	 */
	public SummaryStatistics getBytesRequestS() {
		return bytesRequestS;
	}
	 ...
	 * @generated
	 */
	public void setBytesRequestS(SummaryStatistics newBytesRequestS) {
		SummaryStatistics oldBytesRequestS = bytesRequestS;
		bytesRequestS = newBytesRequestS;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CWDataBasePackage.RECORD_STATISTICS__BYTES_REQUEST_S, oldBytesRequestS, bytesRequestS));
	}
	 ...
	 * @generated
	 */
	public SummaryStatistics getTimeRequestS() {
		return timeRequestS;
	}
	 ...
	 * @generated
	 */
	public void setTimeRequestS(SummaryStatistics newTimeRequestS) {
		SummaryStatistics oldTimeRequestS = timeRequestS;
		timeRequestS = newTimeRequestS;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CWDataBasePackage.RECORD_STATISTICS__TIME_REQUEST_S, oldTimeRequestS, timeRequestS));
	}
	 ...
	 * @generated
	 */
	public SummaryStatistics getCpuLoadS() {
		return cpuLoadS;
	}
	 ...
	 * @generated
	 */
	public void setCpuLoadS(SummaryStatistics newCpuLoadS) {
		SummaryStatistics oldCpuLoadS = cpuLoadS;
		cpuLoadS = newCpuLoadS;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CWDataBasePackage.RECORD_STATISTICS__CPU_LOAD_S, oldCpuLoadS, cpuLoadS));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case CWDataBasePackage.RECORD_STATISTICS__SAMPLES_R:
				...
				return;
			case CWDataBasePackage.RECORD_STATISTICS__BYTES_REQUEST_S:
				setBytesRequestS((SummaryStatistics)newValue);
				return;
			case CWDataBasePackage.RECORD_STATISTICS__TIME_REQUEST_S:
				setTimeRequestS((SummaryStatistics)newValue);
				return;
			case CWDataBasePackage.RECORD_STATISTICS__CPU_LOAD_S:
				setCpuLoadS((SummaryStatistics)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case CWDataBasePackage.RECORD_STATISTICS__SAMPLES_R:
				...
				return;
			case CWDataBasePackage.RECORD_STATISTICS__BYTES_REQUEST_S:
				setBytesRequestS(BYTES_REQUEST_S_EDEFAULT);
				return;
			case CWDataBasePackage.RECORD_STATISTICS__TIME_REQUEST_S:
				setTimeRequestS(TIME_REQUEST_S_EDEFAULT);
				return;
			case CWDataBasePackage.RECORD_STATISTICS__CPU_LOAD_S:
				setCpuLoadS(CPU_LOAD_S_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case CWDataBasePackage.RECORD_STATISTICS__BYTES_REQUEST_S:
				return BYTES_REQUEST_S_EDEFAULT == null ? bytesRequestS != null : !BYTES_REQUEST_S_EDEFAULT.equals(bytesRequestS);
			case CWDataBasePackage.RECORD_STATISTICS__TIME_REQUEST_S:
				return TIME_REQUEST_S_EDEFAULT == null ? timeRequestS != null : !TIME_REQUEST_S_EDEFAULT.equals(timeRequestS);
			case CWDataBasePackage.RECORD_STATISTICS__CPU_LOAD_S:
				return CPU_LOAD_S_EDEFAULT == null ? cpuLoadS != null : !CPU_LOAD_S_EDEFAULT.equals(cpuLoadS);
		}
