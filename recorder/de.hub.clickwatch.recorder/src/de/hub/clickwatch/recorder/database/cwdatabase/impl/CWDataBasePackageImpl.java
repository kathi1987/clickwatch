...
public class CWDataBasePackageImpl extends EPackageImpl implements CWDataBasePackage {
	 ...
	 * @see de.hub.clickwatch.recorder.database.cwdatabase.CWDataBasePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getRecord_NetworkRecorder() {
		return (EAttribute)recordEClass.getEStructuralFeatures().get(10);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(recordEClass, RECORD__NETWORK_RECORDER);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRecord_NetworkRecorder(), this.getNetworkRecorder(), "networkRecorder", null, 0, 1, Record.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
