 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.recorder.database.cwdatabase.impl.DataBaseImpl#getRecords <em>Records</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataBaseImpl extends EObjectImpl implements DataBase {
	...
	public EList<Record> getRecords() {
		if (records == null) {
			records = new EObjectContainmentWithInverseEList<Record>(Record.class, this, CWDataBasePackage.DATA_BASE__RECORDS, CWDataBasePackage.RECORD__DATA_BASE);
		}
		return records;
	}
