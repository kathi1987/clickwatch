...
/**
 * This is the item provider adapter for a {@link de.hub.clickwatch.cwdatabase.ExperimentDescr} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExperimentDescrItemProvider
	...
	protected void addStartPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(new ItemPropertyDescriptor(
				...
				getString("_UI_ExperimentDescr_start_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_ExperimentDescr_start_feature",
						"_UI_ExperimentDescr_type"),
				CWDataBasePackage.Literals.EXPERIMENT_DESCR__START, true,
		...
		itemPropertyDescriptors
				.add(new ItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								"_UI_ExperimentDescr_end_feature",
								"_UI_ExperimentDescr_type"),
						CWDataBasePackage.Literals.EXPERIMENT_DESCR__END, true,
						false, false,
