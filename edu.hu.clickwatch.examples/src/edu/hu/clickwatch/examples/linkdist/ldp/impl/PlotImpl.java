 ...
 * <ul>
 *   <li>{@link edu.hu.clickwatch.examples.linkdist.ldp.impl.PlotImpl#getLinks <em>Links</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlotImpl extends EObjectImpl implements Plot {
	...
	protected EClass eStaticClass() {
		return LinkDistPlotPackage.Literals.PLOT;
	}
	...
	public EList<Link> getLinks() {
		if (links == null) {
			links = new EObjectContainmentEList<Link>(Link.class, this, LinkDistPlotPackage.PLOT__LINKS);
		}
		return links;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LinkDistPlotPackage.PLOT__LINKS:
