 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.analysis.composition.model.impl.ModelNodeImpl#isHasData <em>Has Data</em>}</li>
 *   <li>{@link de.hub.clickwatch.analysis.composition.model.impl.ModelNodeImpl#getVisualization <em>Visualization</em>}</li>
 *   <li>{@link de.hub.clickwatch.analysis.composition.model.impl.ModelNodeImpl#getMetaModelResource <em>Meta Model Resource</em>}</li>
 *   <li>{@link de.hub.clickwatch.analysis.composition.model.impl.ModelNodeImpl#isInferedType <em>Infered Type</em>}</li>
 *   <li>{@link de.hub.clickwatch.analysis.composition.model.impl.ModelNodeImpl#getMetaModelClass <em>Meta Model Class</em>}</li>
 *   <li>{@link de.hub.clickwatch.analysis.composition.model.impl.ModelNodeImpl#getModelResource <em>Model Resource</em>}</li>
 *   <li>{@link de.hub.clickwatch.analysis.composition.model.impl.ModelNodeImpl#isPersistent <em>Persistent</em>}</li>
 *   <li>{@link de.hub.clickwatch.analysis.composition.model.impl.ModelNodeImpl#getRegisteredPackage <em>Registered Package</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
