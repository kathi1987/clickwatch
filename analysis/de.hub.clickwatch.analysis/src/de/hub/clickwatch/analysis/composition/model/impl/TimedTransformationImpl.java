 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.analysis.composition.model.impl.TimedTransformationImpl#getTransformationUri <em>Transformation Uri</em>}</li>
 *   <li>{@link de.hub.clickwatch.analysis.composition.model.impl.TimedTransformationImpl#getTransformationFunction <em>Transformation Function</em>}</li>
 *   <li>{@link de.hub.clickwatch.analysis.composition.model.impl.TimedTransformationImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link de.hub.clickwatch.analysis.composition.model.impl.TimedTransformationImpl#getPredefinedTransformation <em>Predefined Transformation</em>}</li>
 *   <li>{@link de.hub.clickwatch.analysis.composition.model.impl.TimedTransformationImpl#getInput <em>Input</em>}</li>
 *   <li>{@link de.hub.clickwatch.analysis.composition.model.impl.TimedTransformationImpl#getOutput <em>Output</em>}</li>
 *   <li>{@link de.hub.clickwatch.analysis.composition.model.impl.TimedTransformationImpl#getTargetSpec <em>Target Spec</em>}</li>
 *   <li>{@link de.hub.clickwatch.analysis.composition.model.impl.TimedTransformationImpl#getRequiredBundle <em>Required Bundle</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
