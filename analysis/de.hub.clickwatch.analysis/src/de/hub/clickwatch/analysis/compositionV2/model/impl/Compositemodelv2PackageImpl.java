...
import de.hub.clickwatch.analysis.compositionV2.model.ActionNode;
import de.hub.clickwatch.analysis.compositionV2.model.Compositemodelv2Factory;
import de.hub.clickwatch.analysis.compositionV2.model.Compositemodelv2Package;
import de.hub.clickwatch.analysis.compositionV2.model.Composition;
import de.hub.clickwatch.analysis.compositionV2.model.DataEdge;
import de.hub.clickwatch.analysis.compositionV2.model.DataNode;
import de.hub.clickwatch.analysis.compositionV2.model.Edge;
import de.hub.clickwatch.analysis.compositionV2.model.Element;
import de.hub.clickwatch.analysis.compositionV2.model.InputEdge;
import de.hub.clickwatch.analysis.compositionV2.model.ModelNode;
import de.hub.clickwatch.analysis.compositionV2.model.Node;
import de.hub.clickwatch.analysis.compositionV2.model.OutputEdge;
import de.hub.clickwatch.analysis.compositionV2.model.ProgressEdge;
import de.hub.clickwatch.analysis.compositionV2.model.StartNode;
 ...
 * @generated
 */
public class Compositemodelv2PackageImpl extends EPackageImpl implements Compositemodelv2Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see de.hub.clickwatch.analysis.compositionV2.model.Compositemodelv2Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Compositemodelv2PackageImpl() {
		super(eNS_URI, Compositemodelv2Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Compositemodelv2Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Compositemodelv2Package init() {
		if (isInited) return (Compositemodelv2Package)EPackage.Registry.INSTANCE.getEPackage(Compositemodelv2Package.eNS_URI);

		// Obtain or create and register package
		Compositemodelv2PackageImpl theCompositemodelv2Package = (Compositemodelv2PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Compositemodelv2PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Compositemodelv2PackageImpl());

		isInited = true;

		// Create package meta-data objects
		theCompositemodelv2Package.createPackageContents();

		// Initialize created meta-data
		theCompositemodelv2Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theCompositemodelv2Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Compositemodelv2Package.eNS_URI, theCompositemodelv2Package);
		return theCompositemodelv2Package;
	}
	 ...
	 * @generated
	 */
	public Compositemodelv2Factory getCompositemodelv2Factory() {
		return (Compositemodelv2Factory)getEFactoryInstance();
	}
