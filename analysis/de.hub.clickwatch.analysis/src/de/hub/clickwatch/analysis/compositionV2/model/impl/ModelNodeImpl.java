 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.analysis.compositionV2.model.impl.ModelNodeImpl#getMetaModelResource <em>Meta Model Resource</em>}</li>
 *   <li>{@link de.hub.clickwatch.analysis.compositionV2.model.impl.ModelNodeImpl#getMetaModelClass <em>Meta Model Class</em>}</li>
 *   <li>{@link de.hub.clickwatch.analysis.compositionV2.model.impl.ModelNodeImpl#getModelResource <em>Model Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelNodeImpl extends DataNodeImpl implements ModelNode {
	...
	protected EClass eStaticClass() {
		return Compositemodelv2Package.Literals.MODEL_NODE;
	}
	...
	public void setMetaModelResource(String newMetaModelResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Compositemodelv2Package.MODEL_NODE__META_MODEL_RESOURCE, oldMetaModelResource, metaModelResource));
	}
	...
	public void setMetaModelClass(String newMetaModelClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Compositemodelv2Package.MODEL_NODE__META_MODEL_CLASS, oldMetaModelClass, metaModelClass));
	}
	...
	public void setModelResource(String newModelResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Compositemodelv2Package.MODEL_NODE__MODEL_RESOURCE, oldModelResource, modelResource));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Compositemodelv2Package.MODEL_NODE__META_MODEL_RESOURCE:
				return getMetaModelResource();
			case Compositemodelv2Package.MODEL_NODE__META_MODEL_CLASS:
				return getMetaModelClass();
			case Compositemodelv2Package.MODEL_NODE__MODEL_RESOURCE:
