 ...
 * $Id$
 */
package de.hub.clickwatch.analysis.models.topology.impl;
...
import de.hub.clickwatch.analysis.models.topology.TopologyFactory;
...
public class TopologyPackageImpl extends EPackageImpl implements TopologyPackage {
	 ...
	 * @see de.hub.clickwatch.analysis.models.topology.TopologyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getLink_Reverse() {
	 ...
	 * @generated
	 */
	public EReference getTopology_Nodes() {
	 ...
	 * @generated
	 */
	public EReference getTopology_Links() {
	...
	public void createPackageContents() {
		...
		createEAttribute(linkEClass, LINK__PDR);
		createEReference(linkEClass, LINK__REVERSE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getNode_Ip(), ecorePackage.getEString(), "ip", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLink_Target(), this.getNode(), this.getNode_Incomming(), "target", null, 0, 1, Link.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLink_Pdr(), ecorePackage.getEInt(), "pdr", null, 0, 1, Link.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLink_Reverse(), this.getLink(), null, "reverse", null, 0, 1, Link.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
