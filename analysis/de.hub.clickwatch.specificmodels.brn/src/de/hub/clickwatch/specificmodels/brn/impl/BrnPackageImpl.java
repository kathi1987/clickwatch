...
public class BrnPackageImpl extends EPackageImpl implements BrnPackage {
	...
	public void initializePackageContents() {
		...
		Seismo_latestchannelinfosPackage theSeismo_latestchannelinfosPackage = (Seismo_latestchannelinfosPackage)EPackage.Registry.INSTANCE.getEPackage(Seismo_latestchannelinfosPackage.eNS_URI);
		Seismo_smallPackage theSeismo_smallPackage = (Seismo_smallPackage)EPackage.Registry.INSTANCE.getEPackage(Seismo_smallPackage.eNS_URI);
		...
		getESubpackages().add(theSeismo_latestchannelinfosPackage);
		getESubpackages().add(theSeismo_smallPackage);
