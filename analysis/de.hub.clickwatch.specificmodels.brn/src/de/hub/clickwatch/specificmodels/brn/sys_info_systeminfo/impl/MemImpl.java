 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.sys_info_systeminfo.impl.MemImpl#getEContainer_mem <em>EContainer mem</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.sys_info_systeminfo.impl.MemImpl#getTotal <em>Total</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.sys_info_systeminfo.impl.MemImpl#getUsed <em>Used</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.sys_info_systeminfo.impl.MemImpl#getCached <em>Cached</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.sys_info_systeminfo.impl.MemImpl#getBuffers <em>Buffers</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.sys_info_systeminfo.impl.MemImpl#getNFS_Unstable <em>NFS Unstable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public void setEContainer_mem(de.hub.clickwatch.specificmodels.brn.sys_info_systeminfo.System newEContainer_mem) {
		if (newEContainer_mem != eInternalContainer() || (eContainerFeatureID() != Sys_info_systeminfoPackage.MEM__ECONTAINER_MEM && newEContainer_mem != null)) {
			...
			if (newEContainer_mem != null)
				msgs = ((InternalEObject)newEContainer_mem).eInverseAdd(this, Sys_info_systeminfoPackage.SYSTEM__MEM, de.hub.clickwatch.specificmodels.brn.sys_info_systeminfo.System.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Sys_info_systeminfoPackage.MEM__ECONTAINER_MEM:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetEContainer_mem((de.hub.clickwatch.specificmodels.brn.sys_info_systeminfo.System)otherEnd, msgs);
		}
