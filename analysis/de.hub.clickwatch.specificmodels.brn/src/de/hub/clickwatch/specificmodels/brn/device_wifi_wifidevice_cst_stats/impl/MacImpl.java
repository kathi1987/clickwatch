 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getEContainer_mac <em>EContainer mac</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getPackets <em>Packets</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getRx_pkt <em>Rx pkt</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getNo_err_pkt <em>No err pkt</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getCrc_err_pkt <em>Crc err pkt</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getPhy_err_pkt <em>Phy err pkt</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getUnknown_err_pkt <em>Unknown err pkt</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getTx_pkt <em>Tx pkt</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getRx_unicast_pkt <em>Rx unicast pkt</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getRx_retry_pkt <em>Rx retry pkt</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getRx_bcast_pkt <em>Rx bcast pkt</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getRx_bytes <em>Rx bytes</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getTx_unicast_pkt <em>Tx unicast pkt</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getTx_retry_pkt <em>Tx retry pkt</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getTx_bcast_pkt <em>Tx bcast pkt</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getTx_bytes <em>Tx bytes</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getZero_err_pkt <em>Zero err pkt</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getLast_packet_time <em>Last packet time</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_cst_stats.impl.MacImpl#getNo_src <em>No src</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
