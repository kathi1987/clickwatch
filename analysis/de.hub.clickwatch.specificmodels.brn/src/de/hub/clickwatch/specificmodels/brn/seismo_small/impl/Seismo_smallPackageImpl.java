...
import de.hub.clickwatch.specificmodels.brn.seismo_small.Seismo_smallFactory;
 ...
 * @generated
 */
public class Seismo_smallPackageImpl extends EPackageImpl implements Seismo_smallPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see de.hub.clickwatch.specificmodels.brn.seismo_small.Seismo_smallPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Seismo_smallPackageImpl() {
		super(eNS_URI, Seismo_smallFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Seismo_smallPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Seismo_smallPackage init() {
		if (isInited) return (Seismo_smallPackage)EPackage.Registry.INSTANCE.getEPackage(Seismo_smallPackage.eNS_URI);

		// Obtain or create and register package
		Seismo_smallPackageImpl theSeismo_smallPackage = (Seismo_smallPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Seismo_smallPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Seismo_smallPackageImpl());
		...
		theSeismo_smallPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Seismo_smallPackage.eNS_URI, theSeismo_smallPackage);
		return theSeismo_smallPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getSmall_C() {
		return (EReference)smallEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public Seismo_smallFactory getSeismo_smallFactory() {
		return (Seismo_smallFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(cEClass, C__TEXT);
		createEReference(cEClass, C__V);

		smallEClass = createEClass(SMALL);
		createEReference(smallEClass, SMALL__C);
	...
	public void initializePackageContents() {
		...
		smallEClass.getESuperTypes().add(theClickWatchModelPackage.getHandler());

		// Initialize classes and features; add operations and parameters
		initEClass(cEClass, de.hub.clickwatch.specificmodels.brn.seismo_small.C.class, "C", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getC_EContainer_c(), this.getSmall(), this.getSmall_C(), "eContainer_c", null, 0, 1, de.hub.clickwatch.specificmodels.brn.seismo_small.C.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getC_Text(), ecorePackage.getEString(), "text", null, 0, -1, de.hub.clickwatch.specificmodels.brn.seismo_small.C.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getC_V(), this.getV(), this.getV_EContainer_v(), "v", null, 0, -1, de.hub.clickwatch.specificmodels.brn.seismo_small.C.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(smallEClass, Small.class, "Small", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSmall_C(), this.getC(), this.getC_EContainer_c(), "c", null, 0, 1, Small.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(vEClass, de.hub.clickwatch.specificmodels.brn.seismo_small.V.class, "V", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getV_EContainer_v(), this.getC(), this.getC_V(), "eContainer_v", null, 0, 1, de.hub.clickwatch.specificmodels.brn.seismo_small.V.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getV_T(), ecorePackage.getELong(), "t", null, 0, 1, de.hub.clickwatch.specificmodels.brn.seismo_small.V.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getV_C0(), ecorePackage.getEInt(), "c0", null, 0, 1, de.hub.clickwatch.specificmodels.brn.seismo_small.V.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getV_C1(), ecorePackage.getEInt(), "c1", null, 0, 1, de.hub.clickwatch.specificmodels.brn.seismo_small.V.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getV_C2(), ecorePackage.getEInt(), "c2", null, 0, 1, de.hub.clickwatch.specificmodels.brn.seismo_small.V.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createDeAnnotations() {
		...
		addAnnotation
		  (this, 
		   ...
		   new String[] {
			 "handler_class", "Small",
			 "handler_name", "seismo/small"
		   });		
		addAnnotation
		  (cEClass, 
		   source, 
		   new String[] {
			 "target_id", "Small|Handler/c|c:C|EObject"
		   });		
		addAnnotation
		  (getC_Text(), 
		   source, 
		   new String[] {
			 "target_id", "Small|Handler/c|c:C|EObject/text|text:"
		   });		
		addAnnotation
		  (getC_V(), 
		   source, 
		   new String[] {
			 "target_id", "Small|Handler/c|c:C|EObject/v|v:V|EObject",
			 "IsCopy", "false"
		   });		
		addAnnotation
		  (smallEClass, 
		...
		addAnnotation
		  (getV_T(), 
		   source, 
		   new String[] {
			 "target_id", "Small|Handler/c|c:C|EObject/v|v:V|EObject/t|t:"
		   });		
		addAnnotation
		  (getV_C0(), 
		   source, 
		   new String[] {
			 "target_id", "Small|Handler/c|c:C|EObject/v|v:V|EObject/c0|c0:"
		   });		
		addAnnotation
		  (getV_C1(), 
		   source, 
		   new String[] {
			 "target_id", "Small|Handler/c|c:C|EObject/v|v:V|EObject/c1|c1:"
		   });		
		addAnnotation
		  (getV_C2(), 
		   source, 
		   new String[] {
			 "target_id", "Small|Handler/c|c:C|EObject/v|v:V|EObject/c2|c2:"
		   });
	}

} //Seismo_smallPackageImpl
