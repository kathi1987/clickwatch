 ...
 * @generated
 */
public class Gps_cart_coordSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Gps_cart_coordPackage.CART_COORD: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Cart coord</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Cart coord</em>'.
