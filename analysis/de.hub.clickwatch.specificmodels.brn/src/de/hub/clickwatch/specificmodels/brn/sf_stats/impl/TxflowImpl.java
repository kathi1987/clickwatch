 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.sf_stats.impl.TxflowImpl#getEContainer_txflow <em>EContainer txflow</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.sf_stats.impl.TxflowImpl#getSrc <em>Src</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.sf_stats.impl.TxflowImpl#getDst <em>Dst</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.sf_stats.impl.TxflowImpl#getFlowid <em>Flowid</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.sf_stats.impl.TxflowImpl#getPacket_count <em>Packet count</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.sf_stats.impl.TxflowImpl#getPacket_size <em>Packet size</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.sf_stats.impl.TxflowImpl#getReplies <em>Replies</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.sf_stats.impl.TxflowImpl#getAvg_hops <em>Avg hops</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.sf_stats.impl.TxflowImpl#getTime <em>Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
