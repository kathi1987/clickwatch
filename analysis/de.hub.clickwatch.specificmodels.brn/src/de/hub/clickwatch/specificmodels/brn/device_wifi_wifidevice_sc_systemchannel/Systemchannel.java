 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_sc_systemchannel.Systemchannel#getSetchannel <em>Setchannel</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_sc_systemchannel.Device_wifi_wifidevice_sc_systemchannelPackage#getSystemchannel()
 * @model annotation="http://de.hub.clickwatch.specificmodels target_id='Systemchannel|Handler'"
 * @generated
 */
public interface Systemchannel extends Handler {
    /**
     * Returns the value of the '<em><b>Setchannel</b></em>' containment reference.
     * It is bidirectional and its opposite is '{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_sc_systemchannel.Setchannel#getEContainer_setchannel <em>EContainer setchannel</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_sc_systemchannel.Device_wifi_wifidevice_sc_systemchannelPackage#getSystemchannel_Setchannel()
    ...
    /**
     * Sets the value of the '{@link de.hub.clickwatch.specificmodels.brn.device_wifi_wifidevice_sc_systemchannel.Systemchannel#getSetchannel <em>Setchannel</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
