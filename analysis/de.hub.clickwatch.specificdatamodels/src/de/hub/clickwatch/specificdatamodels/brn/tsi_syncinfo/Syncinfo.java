 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.tsi_syncinfo.Syncinfo#getTimesyncinfo <em>Timesyncinfo</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.clickwatch.specificdatamodels.brn.tsi_syncinfo.Tsi_syncinfoPackage#getSyncinfo()
 * @model annotation="http://de.hub.clickwatch.specificmodels target_id='Syncinfo|Handler'"
 * @generated
 */
public interface Syncinfo extends Value {
	/**
	 * Returns the value of the '<em><b>Timesyncinfo</b></em>' containment reference.
	 * It is bidirectional and its opposite is '{@link de.hub.clickwatch.specificdatamodels.brn.tsi_syncinfo.Timesyncinfo#getEContainer_timesyncinfo <em>EContainer timesyncinfo</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.hub.clickwatch.specificdatamodels.brn.tsi_syncinfo.Tsi_syncinfoPackage#getSyncinfo_Timesyncinfo()
	...
	/**
	 * Sets the value of the '{@link de.hub.clickwatch.specificdatamodels.brn.tsi_syncinfo.Syncinfo#getTimesyncinfo <em>Timesyncinfo</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
