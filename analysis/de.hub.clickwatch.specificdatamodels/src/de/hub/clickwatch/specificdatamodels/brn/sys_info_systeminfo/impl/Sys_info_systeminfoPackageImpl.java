...
import de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.Sys_info_systeminfoFactory;
...
import de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.Uptime;
...
public class Sys_info_systeminfoPackageImpl extends EPackageImpl implements Sys_info_systeminfoPackage {
	 ...
	 * @see de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.Sys_info_systeminfoPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		systeminfoEClass.getESuperTypes().add(theClickWatchDataModelPackage.getValue());
		...
		initEClass(systemEClass, de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSystem_EContainer_system(), this.getSysteminfo(), this.getSysteminfo_System(), "eContainer_system", null, 0, 1, de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSystem_Text(), ecorePackage.getEString(), "text", null, 0, -1, de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Mem(), this.getMem(), this.getMem_EContainer_mem(), "mem", null, 0, 1, de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Loadavg(), this.getLoadavg(), this.getLoadavg_EContainer_loadavg(), "loadavg", null, 0, 1, de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Cpu_usage(), this.getCpu_usage(), this.getCpu_usage_EContainer_cpu_usage(), "cpu_usage", null, 0, 1, de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Uptime(), this.getUptime(), this.getUptime_EContainer_uptime(), "uptime", null, 0, 1, de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Linux(), this.getLinux(), this.getLinux_EContainer_linux(), "linux", null, 0, 1, de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSystem_Id(), ecorePackage.getEString(), "id", null, 0, 1, de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSystem_Name(), ecorePackage.getEString(), "name", null, 0, 1, de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSystem_Time(), ecorePackage.getEDouble(), "time", null, 0, 1, de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
