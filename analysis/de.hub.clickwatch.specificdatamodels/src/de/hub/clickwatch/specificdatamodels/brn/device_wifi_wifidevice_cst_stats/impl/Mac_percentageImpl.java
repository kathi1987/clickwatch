 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.Mac_percentageImpl#getEContainer_mac_percentage <em>EContainer mac percentage</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.Mac_percentageImpl#getBusy <em>Busy</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.Mac_percentageImpl#getRx <em>Rx</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.Mac_percentageImpl#getTx <em>Tx</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.Mac_percentageImpl#getNoerr_rx <em>Noerr rx</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.Mac_percentageImpl#getCrc_rx <em>Crc rx</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.Mac_percentageImpl#getPhy_rx <em>Phy rx</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.Mac_percentageImpl#getUnknown_err_rx <em>Unknown err rx</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.Mac_percentageImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
