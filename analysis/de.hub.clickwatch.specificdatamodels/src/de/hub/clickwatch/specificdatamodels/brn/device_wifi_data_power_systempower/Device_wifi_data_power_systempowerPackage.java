...
public interface Device_wifi_data_power_systempowerPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int SYSTEMPOWER__NAME = ClickWatchDataModelPackage.VALUE__NAME;
	 ...
	 * @ordered
	 */
	int SYSTEMPOWER__CAN_READ = ClickWatchDataModelPackage.VALUE__CAN_READ;
	 ...
	 * @ordered
	 */
	int SYSTEMPOWER__CAN_WRITE = ClickWatchDataModelPackage.VALUE__CAN_WRITE;
	 ...
	 * @ordered
	 */
	int SYSTEMPOWER__CHANGED = ClickWatchDataModelPackage.VALUE__CHANGED;
