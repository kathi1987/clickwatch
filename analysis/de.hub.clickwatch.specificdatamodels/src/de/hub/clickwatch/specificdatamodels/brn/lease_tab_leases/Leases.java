 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.lease_tab_leases.Leases#getDhcpleases <em>Dhcpleases</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.clickwatch.specificdatamodels.brn.lease_tab_leases.Lease_tab_leasesPackage#getLeases()
 * @model annotation="http://de.hub.clickwatch.specificmodels target_id='Leases|Handler'"
 * @generated
 */
public interface Leases extends Value {
	/**
	 * Returns the value of the '<em><b>Dhcpleases</b></em>' containment reference.
	 * It is bidirectional and its opposite is '{@link de.hub.clickwatch.specificdatamodels.brn.lease_tab_leases.Dhcpleases#getEContainer_dhcpleases <em>EContainer dhcpleases</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.hub.clickwatch.specificdatamodels.brn.lease_tab_leases.Lease_tab_leasesPackage#getLeases_Dhcpleases()
	...
	/**
	 * Sets the value of the '{@link de.hub.clickwatch.specificdatamodels.brn.lease_tab_leases.Leases#getDhcpleases <em>Dhcpleases</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
