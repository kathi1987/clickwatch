 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.C#getEContainer_c <em>EContainer c</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.C#getV <em>V</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.Seismo_localchannelinfoPackage#getC()
...
public interface C extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.Localchannelinfo#getC <em>C</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.Seismo_localchannelinfoPackage#getC_EContainer_c()
	...
	/**
	 * Sets the value of the '{@link de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.C#getEContainer_c <em>EContainer c</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.V}.
	 * It is bidirectional and its opposite is '{@link de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.V#getEContainer_v <em>EContainer v</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.Seismo_localchannelinfoPackage#getC_V()
