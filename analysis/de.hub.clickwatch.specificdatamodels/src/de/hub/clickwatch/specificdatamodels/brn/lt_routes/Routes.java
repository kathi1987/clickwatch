 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.lt_routes.Routes#getRoutetable <em>Routetable</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.clickwatch.specificdatamodels.brn.lt_routes.Lt_routesPackage#getRoutes()
 * @model annotation="http://de.hub.clickwatch.specificmodels target_id='Routes|Handler'"
 * @generated
 */
public interface Routes extends Value {
	/**
	 * Returns the value of the '<em><b>Routetable</b></em>' containment reference.
	 * It is bidirectional and its opposite is '{@link de.hub.clickwatch.specificdatamodels.brn.lt_routes.Routetable#getEContainer_routetable <em>EContainer routetable</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.hub.clickwatch.specificdatamodels.brn.lt_routes.Lt_routesPackage#getRoutes_Routetable()
	...
	/**
	 * Sets the value of the '{@link de.hub.clickwatch.specificdatamodels.brn.lt_routes.Routes#getRoutetable <em>Routetable</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
