 ...
 * $Id$
 */
package de.hub.clickwatch.specificdatamodels.brn.lt_routes.util;

import de.hub.clickwatch.datamodel.Value;

import de.hub.clickwatch.model.Handler;
import de.hub.clickwatch.specificdatamodels.brn.lt_routes.*;
...
public class Lt_routesAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hub.clickwatch.specificdatamodels.brn.lt_routes.Link <em>Link</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hub.clickwatch.specificdatamodels.brn.lt_routes.Route <em>Route</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hub.clickwatch.specificdatamodels.brn.lt_routes.Routes <em>Routes</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hub.clickwatch.specificdatamodels.brn.lt_routes.Routetable <em>Routetable</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
