...
public class Sys_info_systeminfoSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Sys_info_systeminfoPackage.SYSTEM: {
				de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System system = (de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System)theEObject;
	 ...
	 * @generated
	 */
	public T caseSystem(de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System object) {
		return null;
	}
