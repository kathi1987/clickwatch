 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.PhyImpl#getEContainer_phy <em>EContainer phy</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.PhyImpl#getHwbusy <em>Hwbusy</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.PhyImpl#getHwrx <em>Hwrx</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.PhyImpl#getHwtx <em>Hwtx</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.PhyImpl#getLast_hw_stat_time <em>Last hw stat time</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.PhyImpl#getHw_stats_count <em>Hw stats count</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.PhyImpl#getAvg_noise <em>Avg noise</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.PhyImpl#getStd_noise <em>Std noise</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.PhyImpl#getAvg_rssi <em>Avg rssi</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.PhyImpl#getStd_rssi <em>Std rssi</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.PhyImpl#getCtl_rssi0 <em>Ctl rssi0</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.PhyImpl#getCtl_rssi1 <em>Ctl rssi1</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.PhyImpl#getCtl_rssi2 <em>Ctl rssi2</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.PhyImpl#getExt_rssi0 <em>Ext rssi0</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.PhyImpl#getExt_rssi1 <em>Ext rssi1</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.PhyImpl#getExt_rssi2 <em>Ext rssi2</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.impl.PhyImpl#getChannel <em>Channel</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
