 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_link_stat_bcast_stats.impl.EntryImpl#getEContainer_entry <em>EContainer entry</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_link_stat_bcast_stats.impl.EntryImpl#getText <em>Text</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_link_stat_bcast_stats.impl.EntryImpl#getLink <em>Link</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_link_stat_bcast_stats.impl.EntryImpl#getFrom <em>From</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_link_stat_bcast_stats.impl.EntryImpl#getTime <em>Time</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_link_stat_bcast_stats.impl.EntryImpl#getSeq <em>Seq</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_link_stat_bcast_stats.impl.EntryImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_link_stat_bcast_stats.impl.EntryImpl#getTau <em>Tau</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
