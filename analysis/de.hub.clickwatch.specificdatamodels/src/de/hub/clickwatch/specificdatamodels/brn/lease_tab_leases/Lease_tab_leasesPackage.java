...
public interface Lease_tab_leasesPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int LEASES__NAME = ClickWatchDataModelPackage.VALUE__NAME;
	 ...
	 * @ordered
	 */
	int LEASES__CAN_READ = ClickWatchDataModelPackage.VALUE__CAN_READ;
	 ...
	 * @ordered
	 */
	int LEASES__CAN_WRITE = ClickWatchDataModelPackage.VALUE__CAN_WRITE;
	 ...
	 * @ordered
	 */
	int LEASES__CHANGED = ClickWatchDataModelPackage.VALUE__CHANGED;
