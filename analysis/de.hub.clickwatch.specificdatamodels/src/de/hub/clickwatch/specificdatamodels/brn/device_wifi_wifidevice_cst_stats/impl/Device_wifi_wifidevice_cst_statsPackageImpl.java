...
import de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.Device_wifi_wifidevice_cst_statsFactory;
...
public class Device_wifi_wifidevice_cst_statsPackageImpl extends EPackageImpl implements Device_wifi_wifidevice_cst_statsPackage {
	 ...
	 * @see de.hub.clickwatch.specificdatamodels.brn.device_wifi_wifidevice_cst_stats.Device_wifi_wifidevice_cst_statsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		statsEClass.getESuperTypes().add(theClickWatchDataModelPackage.getValue());
		statsEClass.getESuperTypes().add(theTraceablePackage.getTraceable());
