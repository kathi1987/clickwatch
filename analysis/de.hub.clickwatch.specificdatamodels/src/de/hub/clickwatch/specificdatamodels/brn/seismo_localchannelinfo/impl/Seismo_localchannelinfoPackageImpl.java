...
import de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.Seismo_localchannelinfoFactory;
...
public class Seismo_localchannelinfoPackageImpl extends EPackageImpl implements Seismo_localchannelinfoPackage {
	 ...
	 * @see de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.Seismo_localchannelinfoPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		localchannelinfoEClass.getESuperTypes().add(theClickWatchDataModelPackage.getValue());

		// Initialize classes and features; add operations and parameters
		initEClass(cEClass, de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.C.class, "C", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getC_EContainer_c(), this.getLocalchannelinfo(), this.getLocalchannelinfo_C(), "eContainer_c", null, 0, 1, de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.C.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getC_V(), this.getV(), this.getV_EContainer_v(), "v", null, 0, -1, de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.C.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(vEClass, de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.V.class, "V", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getV_EContainer_v(), this.getC(), this.getC_V(), "eContainer_v", null, 0, 1, de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.V.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getV_T(), ecorePackage.getELong(), "t", null, 0, 1, de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.V.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getV_S(), ecorePackage.getELong(), "s", null, 0, 1, de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.V.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getV_C0(), ecorePackage.getEInt(), "c0", null, 0, 1, de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.V.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getV_C1(), ecorePackage.getEInt(), "c1", null, 0, 1, de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.V.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getV_C2(), ecorePackage.getEInt(), "c2", null, 0, 1, de.hub.clickwatch.specificdatamodels.brn.seismo_localchannelinfo.V.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
