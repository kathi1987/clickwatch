 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_data_power_systempower.Systempower#getSettxpower <em>Settxpower</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.clickwatch.specificdatamodels.brn.device_wifi_data_power_systempower.Device_wifi_data_power_systempowerPackage#getSystempower()
 * @model annotation="http://de.hub.clickwatch.specificmodels target_id='Systempower|Handler'"
 * @generated
 */
public interface Systempower extends Value {
	/**
	 * Returns the value of the '<em><b>Settxpower</b></em>' containment reference.
	 * It is bidirectional and its opposite is '{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_data_power_systempower.Settxpower#getEContainer_settxpower <em>EContainer settxpower</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.hub.clickwatch.specificdatamodels.brn.device_wifi_data_power_systempower.Device_wifi_data_power_systempowerPackage#getSystempower_Settxpower()
	...
	/**
	 * Sets the value of the '{@link de.hub.clickwatch.specificdatamodels.brn.device_wifi_data_power_systempower.Systempower#getSettxpower <em>Settxpower</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
