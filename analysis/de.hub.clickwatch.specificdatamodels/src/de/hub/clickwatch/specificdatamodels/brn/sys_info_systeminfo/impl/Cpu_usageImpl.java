 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.impl.Cpu_usageImpl#getEContainer_cpu_usage <em>EContainer cpu usage</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.impl.Cpu_usageImpl#getReal <em>Real</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.impl.Cpu_usageImpl#getUser <em>User</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.impl.Cpu_usageImpl#getSys <em>Sys</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.impl.Cpu_usageImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Cpu_usageImpl extends EObjectImpl implements Cpu_usage {
	 ...
	 * @generated
	 */
	public de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System getEContainer_cpu_usage() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetEContainer_cpu_usage(de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System newEContainer_cpu_usage, NotificationChain msgs) {
	 ...
	 * @generated
	 */
	public void setEContainer_cpu_usage(de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System newEContainer_cpu_usage) {
		if (newEContainer_cpu_usage != eInternalContainer() || (eContainerFeatureID() != Sys_info_systeminfoPackage.CPU_USAGE__ECONTAINER_CPU_USAGE && newEContainer_cpu_usage != null)) {
			...
			if (newEContainer_cpu_usage != null)
				msgs = ((InternalEObject)newEContainer_cpu_usage).eInverseAdd(this, Sys_info_systeminfoPackage.SYSTEM__CPU_USAGE, de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Sys_info_systeminfoPackage.CPU_USAGE__ECONTAINER_CPU_USAGE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetEContainer_cpu_usage((de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System)otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case Sys_info_systeminfoPackage.CPU_USAGE__ECONTAINER_CPU_USAGE:
				return eInternalContainer().eInverseRemove(this, Sys_info_systeminfoPackage.SYSTEM__CPU_USAGE, de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Sys_info_systeminfoPackage.CPU_USAGE__ECONTAINER_CPU_USAGE:
				setEContainer_cpu_usage((de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System)newValue);
				return;
			case Sys_info_systeminfoPackage.CPU_USAGE__REAL:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case Sys_info_systeminfoPackage.CPU_USAGE__ECONTAINER_CPU_USAGE:
				setEContainer_cpu_usage((de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System)null);
				return;
			case Sys_info_systeminfoPackage.CPU_USAGE__REAL:
