 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.impl.SystemImpl#getEContainer_system <em>EContainer system</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.impl.SystemImpl#getText <em>Text</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.impl.SystemImpl#getMem <em>Mem</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.impl.SystemImpl#getLoadavg <em>Loadavg</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.impl.SystemImpl#getCpu_usage <em>Cpu usage</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.impl.SystemImpl#getUptime <em>Uptime</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.impl.SystemImpl#getLinux <em>Linux</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.impl.SystemImpl#getId <em>Id</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.impl.SystemImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.impl.SystemImpl#getTime <em>Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SystemImpl extends EObjectImpl implements de.hub.clickwatch.specificdatamodels.brn.sys_info_systeminfo.System {
	/**
