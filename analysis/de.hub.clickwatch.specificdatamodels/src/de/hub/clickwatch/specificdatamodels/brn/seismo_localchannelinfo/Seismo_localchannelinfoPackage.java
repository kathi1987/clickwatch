...
public interface Seismo_localchannelinfoPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int LOCALCHANNELINFO__NAME = ClickWatchDataModelPackage.VALUE__NAME;
	 ...
	 * @ordered
	 */
	int LOCALCHANNELINFO__CAN_READ = ClickWatchDataModelPackage.VALUE__CAN_READ;
	 ...
	 * @ordered
	 */
	int LOCALCHANNELINFO__CAN_WRITE = ClickWatchDataModelPackage.VALUE__CAN_WRITE;
	 ...
	 * @ordered
	 */
	int LOCALCHANNELINFO__CHANGED = ClickWatchDataModelPackage.VALUE__CHANGED;
