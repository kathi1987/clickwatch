...
/**
 * This is the item provider adapter for a {@link de.hub.clickwatch.analysis.results.ValueSpec} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValueSpecItemProvider
	 ...
	 * @generated
	 */
	public ValueSpecItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ValueSpec_column_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ValueSpec_column_feature", "_UI_ValueSpec_type"),
				 ResultsPackage.Literals.VALUE_SPEC__COLUMN,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ValueSpec)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ValueSpec_type") :
			getString("_UI_ValueSpec_type") + " " + label;
	}
