...
/**
 * This is the item provider adapter for a {@link de.hub.clickwatch.analysis.results.Axis} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Axis_to_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Axis_to_feature", "_UI_Axis_type"),
				 ResultsPackage.Literals.AXIS__TO,
				 true,
				 false,
				 false,
	...
	protected void addFromPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Axis_from_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Axis_from_feature", "_UI_Axis_type"),
				 ResultsPackage.Literals.AXIS__FROM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
