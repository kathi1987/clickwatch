 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.analysis.activity_composition.model.impl.ElementImpl#getLabel <em>Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ElementImpl extends EObjectImpl implements Element {
	...
	public void setLabel(String newLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ELEMENT__LABEL, oldLabel, label));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.ELEMENT__LABEL:
				return getLabel();
		}
