 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.analysis.activity_composition.model.impl.CompositionImpl#getContents <em>Contents</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompositionImpl extends EObjectImpl implements Composition {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.COMPOSITION;
	}
	...
	public EList<Element> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentEList<Element>(Element.class, this, ModelPackage.COMPOSITION__CONTENTS);
		}
		return contents;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.COMPOSITION__CONTENTS:
