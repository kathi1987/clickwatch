...
public interface Style {
	...
	public static final IColorConstant STARTNODE_FOREGROUND = new ColorConstant(255, 255, 255);
	public static final IColorConstant STARTNODE_BACKGROUND = new ColorConstant(0, 0, 0);
