...
public class ResultsPackageImpl extends EPackageImpl implements ResultsPackage {
	 ...
	 * @generated
	 */
	private EClass dataResultSetEClass = null;
	 ...
	 * @generated
	 */
	private EClass xyDataResultSetEClass = null;
	 ...
	 * @generated
	 */
	private EClass doubleDataResultValueEClass = null;
	 ...
	 * @generated
	 */
	private EClass dataResultValueEClass = null;
	 ...
	 * @generated
	 */
	public EReference getNumericalResult_DataResultSet() {
		return (EReference)numericalResultEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getDataResultSet() {
		return dataResultSetEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getXYDataResultSet() {
		return xyDataResultSetEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getXYDataResultSet_Name() {
		return (EAttribute)xyDataResultSetEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getXYDataResultSet_XValues() {
		return (EReference)xyDataResultSetEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getXYDataResultSet_YValues() {
		return (EReference)xyDataResultSetEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getDoubleDataResultValue() {
		return doubleDataResultValueEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getDoubleDataResultValue_Value() {
		return (EAttribute)doubleDataResultValueEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getDataResultValue() {
		return dataResultValueEClass;
	}
	...
	public void createPackageContents() {
		...
		createEReference(numericalResultEClass, NUMERICAL_RESULT__DATA_RESULT_SET);
		...
		dataResultSetEClass = createEClass(DATA_RESULT_SET);

		xyDataResultSetEClass = createEClass(XY_DATA_RESULT_SET);
		createEAttribute(xyDataResultSetEClass, XY_DATA_RESULT_SET__NAME);
		createEReference(xyDataResultSetEClass, XY_DATA_RESULT_SET__XVALUES);
		createEReference(xyDataResultSetEClass, XY_DATA_RESULT_SET__YVALUES);

		doubleDataResultValueEClass = createEClass(DOUBLE_DATA_RESULT_VALUE);
		createEAttribute(doubleDataResultValueEClass, DOUBLE_DATA_RESULT_VALUE__VALUE);

		dataResultValueEClass = createEClass(DATA_RESULT_VALUE);
	...
	public void initializePackageContents() {
		...
		initEReference(getNumericalResult_DataResultSet(), this.getDataResultSet(), null, "dataResultSet", null, 0, 1, NumericalResult.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(dataResultSetEClass, DataResultSet.class, "DataResultSet", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(xyDataResultSetEClass, XYDataResultSet.class, "XYDataResultSet", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getXYDataResultSet_Name(), ecorePackage.getEString(), "name", null, 0, 1, XYDataResultSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getXYDataResultSet_XValues(), this.getDataResultValue(), null, "xValues", null, 0, -1, XYDataResultSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getXYDataResultSet_YValues(), this.getDataResultValue(), null, "yValues", null, 0, -1, XYDataResultSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(doubleDataResultValueEClass, DoubleDataResultValue.class, "DoubleDataResultValue", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDoubleDataResultValue_Value(), ecorePackage.getEDouble(), "value", null, 0, 1, DoubleDataResultValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(dataResultValueEClass, DataResultValue.class, "DataResultValue", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
