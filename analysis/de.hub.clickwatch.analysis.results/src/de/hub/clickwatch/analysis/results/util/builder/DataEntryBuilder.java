...
public class DataEntryBuilder implements de.hub.clickwatch.analysis.results.util.builder.IResultsBuilder<de.hub.clickwatch.analysis.results.DataEntry> {
  ...
  private java.util.Collection<java.lang.Object> m_values = new java.util.LinkedList<java.lang.Object>();
  // helper attributes
  ...
  public DataEntryBuilder withName(java.lang.String p_name) {
    m_name = p_name;
    m_featureNameSet = true;
    return this;
  }

  public DataEntryBuilder withValues(java.lang.Object p_values) {
    m_values.add(p_values);
    m_featureValuesSet = true;
    return this;
  }

  public DataEntryBuilder withValues(java.util.Collection<? extends java.lang.Object> p_values) {
