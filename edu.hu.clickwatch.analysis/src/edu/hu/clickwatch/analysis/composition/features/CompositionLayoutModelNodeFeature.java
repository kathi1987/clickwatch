...
public class CompositionLayoutModelNodeFeature extends AbstractLayoutFeature {

	private static final int MIN_HEIGHT = 50;

	private static final int MIN_WIDTH = 50;

	public CompositionLayoutModelNodeFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean layout(ILayoutContext context) {
		...
		int rectangleWidth = containerGa.getWidth() - CompositionAddModelNodeFeature.INVISIBLE_RECT_RIGHT;
