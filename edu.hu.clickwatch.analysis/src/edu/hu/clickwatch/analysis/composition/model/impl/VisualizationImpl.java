 ...
 * <ul>
 *   <li>{@link edu.hu.clickwatch.analysis.composition.model.impl.VisualizationImpl#getKind <em>Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VisualizationImpl extends EObjectImpl implements Visualization {
	...
	protected EClass eStaticClass() {
		return CompositionPackage.Literals.VISUALIZATION;
	}
	...
	public void setKind(String newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompositionPackage.VISUALIZATION__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompositionPackage.VISUALIZATION__KIND:
				return getKind();
		}
