...
public class NetworkBuilder implements de.hub.clickwatch.model.util.builder.IModelBuilder<de.hub.clickwatch.model.Network> {
  ...
  private de.hub.clickwatch.model.MultiNode m_all;
  private de.hub.clickwatch.model.util.builder.IModelBuilder<? extends de.hub.clickwatch.model.MultiNode> m_featureAllBuilder;
  ...
  private boolean m_featureAllSet = false;
  ...
  public NetworkBuilder but() {
    ...
    _builder.m_featureAllSet = m_featureAllSet;
    _builder.m_all = m_all;
    _builder.m_featureAllBuilder = m_featureAllBuilder;
  ...
  public de.hub.clickwatch.model.Network build() {
    ...
    if (m_featureAllSet) {
      _newInstance.setAll(m_all);
    } else {
      if (m_featureAllBuilder != null) {
        _newInstance.setAll(m_featureAllBuilder.build());
      }
    }
    if (m_featureNameSet) {
  ...
  public NetworkBuilder withAll(de.hub.clickwatch.model.MultiNode p_all) {
    m_all = p_all;
    m_featureAllSet = true;
    return this;
  }

  public NetworkBuilder withAll(de.hub.clickwatch.model.util.builder.IModelBuilder<? extends de.hub.clickwatch.model.MultiNode> p_multiNodeBuilder) {
    m_featureAllBuilder = p_multiNodeBuilder;
    return this;
  }
