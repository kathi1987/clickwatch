...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object ' <em><b>de.hub.clickwatch.cwdatabase.ExperimentDescr</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class ExperimentDescrBuilder implements de.hub.clickwatch.cwdatabase.util.builder.ICwdatabaseBuilder<de.hub.clickwatch.cwdatabase.ExperimentDescr> {
  // features and builders
  private de.hub.clickwatch.cwdatabase.DataBase m_dataBase;
  private de.hub.clickwatch.cwdatabase.util.builder.ICwdatabaseBuilder<? extends de.hub.clickwatch.cwdatabase.DataBase> m_featureDataBaseBuilder;
  ...
  private de.hub.clickwatch.cwdatabase.ExperimentRecord m_record;
  private de.hub.clickwatch.cwdatabase.util.builder.ICwdatabaseBuilder<? extends de.hub.clickwatch.cwdatabase.ExperimentRecord> m_featureRecordBuilder;
  private long m_start;
  private de.hub.clickwatch.cwdatabase.ExperimentStatistics m_statistics;
  private de.hub.clickwatch.cwdatabase.util.builder.ICwdatabaseBuilder<? extends de.hub.clickwatch.cwdatabase.ExperimentStatistics> m_featureStatisticsBuilder;
  // helper attributes
  ...
  /**
   * This method constructs the final de.hub.clickwatch.cwdatabase.ExperimentDescr type.
   * @return new instance of the de.hub.clickwatch.cwdatabase.ExperimentDescr type
   */
  public de.hub.clickwatch.cwdatabase.ExperimentDescr build() {
    final de.hub.clickwatch.cwdatabase.ExperimentDescr _newInstance = de.hub.clickwatch.cwdatabase.CWDataBaseFactory.eINSTANCE.createExperimentDescr();
  ...
  public ExperimentDescrBuilder withDataBase(de.hub.clickwatch.cwdatabase.DataBase p_dataBase) {
    m_dataBase = p_dataBase;
    m_featureDataBaseSet = true;
    return this;
  }

  public ExperimentDescrBuilder withDataBase(de.hub.clickwatch.cwdatabase.util.builder.ICwdatabaseBuilder<? extends de.hub.clickwatch.cwdatabase.DataBase> p_dataBaseBuilder) {
  ...
  public ExperimentDescrBuilder withRecord(de.hub.clickwatch.cwdatabase.ExperimentRecord p_record) {
    m_record = p_record;
    m_featureRecordSet = true;
    return this;
  }

  public ExperimentDescrBuilder withRecord(de.hub.clickwatch.cwdatabase.util.builder.ICwdatabaseBuilder<? extends de.hub.clickwatch.cwdatabase.ExperimentRecord> p_experimentRecordBuilder) {
  ...
  public ExperimentDescrBuilder withStatistics(de.hub.clickwatch.cwdatabase.ExperimentStatistics p_statistics) {
    m_statistics = p_statistics;
    m_featureStatisticsSet = true;
    return this;
  }

  public ExperimentDescrBuilder withStatistics(de.hub.clickwatch.cwdatabase.util.builder.ICwdatabaseBuilder<? extends de.hub.clickwatch.cwdatabase.ExperimentStatistics> p_experimentStatisticsBuilder) {
