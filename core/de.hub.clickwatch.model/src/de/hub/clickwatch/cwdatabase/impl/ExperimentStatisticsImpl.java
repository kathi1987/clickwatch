 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.cwdatabase.impl.ExperimentStatisticsImpl#getNodesA <em>Nodes A</em>}</li>
 *   <li>{@link de.hub.clickwatch.cwdatabase.impl.ExperimentStatisticsImpl#getSamplesN <em>Samples N</em>}</li>
 *   <li>{@link de.hub.clickwatch.cwdatabase.impl.ExperimentStatisticsImpl#getHandlersN <em>Handlers N</em>}</li>
 *   <li>{@link de.hub.clickwatch.cwdatabase.impl.ExperimentStatisticsImpl#getHandlersPulledS <em>Handlers Pulled S</em>}</li>
 *   <li>{@link de.hub.clickwatch.cwdatabase.impl.ExperimentStatisticsImpl#getHandlersR <em>Handlers R</em>}</li>
 *   <li>{@link de.hub.clickwatch.cwdatabase.impl.ExperimentStatisticsImpl#getTimeA <em>Time A</em>}</li>
 *   <li>{@link de.hub.clickwatch.cwdatabase.impl.ExperimentStatisticsImpl#getTimeN <em>Time N</em>}</li>
 *   <li>{@link de.hub.clickwatch.cwdatabase.impl.ExperimentStatisticsImpl#getTimeS <em>Time S</em>}</li>
 *   <li>{@link de.hub.clickwatch.cwdatabase.impl.ExperimentStatisticsImpl#getSamplesPerSecond <em>Samples Per Second</em>}</li>
 *   <li>{@link de.hub.clickwatch.cwdatabase.impl.ExperimentStatisticsImpl#getRecordSize <em>Record Size</em>}</li>
 *   <li>{@link de.hub.clickwatch.cwdatabase.impl.ExperimentStatisticsImpl#getSamplesR <em>Samples R</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExperimentStatisticsImpl extends EObjectImpl implements ExperimentStatistics {
	...
	public double getSamplesPerSecond() {
		return getSamplesN().getSum() / (getTimeN().getSum() / 1000000000);
	}
