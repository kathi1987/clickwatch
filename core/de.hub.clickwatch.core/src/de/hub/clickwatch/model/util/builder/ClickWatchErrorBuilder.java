...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object ' <em><b>de.hub.clickwatch.model.ClickWatchError</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class ClickWatchErrorBuilder implements de.hub.clickwatch.model.util.builder.IModelBuilder<de.hub.clickwatch.model.ClickWatchError> {
  ...
  /**
   * This method constructs the final de.hub.clickwatch.model.ClickWatchError type.
   * @return new instance of the de.hub.clickwatch.model.ClickWatchError type
   */
  public de.hub.clickwatch.model.ClickWatchError build() {
    final de.hub.clickwatch.model.ClickWatchError _newInstance = de.hub.clickwatch.model.ClickWatchModelFactory.eINSTANCE.createClickWatchError();
