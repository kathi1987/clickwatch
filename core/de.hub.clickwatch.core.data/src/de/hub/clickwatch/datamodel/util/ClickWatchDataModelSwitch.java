 ...
 * @generated
 */
public class ClickWatchDataModelSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ClickWatchDataModelSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ClickWatchDataModelPackage.NODE: {
			...
			case ClickWatchDataModelPackage.NETWORK: {
			...
			case ClickWatchDataModelPackage.MODEL_ELEMENT_WITH_STATISTICS: {
			...
			case ClickWatchDataModelPackage.STATISTICS_CONTAINER: {
			...
			case ClickWatchDataModelPackage.ESTRING_TO_STATISTIC_MAP: {
	 ...
	 * @generated
	 */
	public T caseClickWatchModel_Handler(de.hub.clickwatch.model.Handler object) {
		return null;
	}
