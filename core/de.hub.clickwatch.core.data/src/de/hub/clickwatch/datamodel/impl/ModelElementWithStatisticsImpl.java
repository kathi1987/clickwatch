 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.datamodel.impl.ModelElementWithStatisticsImpl#getStatistics <em>Statistics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ModelElementWithStatisticsImpl extends EObjectImpl implements ModelElementWithStatistics {
    ...
    protected EClass eStaticClass() {
		return ClickWatchDataModelPackage.Literals.MODEL_ELEMENT_WITH_STATISTICS;
	}
    ...
    public NotificationChain basicSetStatistics(StatisticsContainer newStatistics, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ClickWatchDataModelPackage.MODEL_ELEMENT_WITH_STATISTICS__STATISTICS, oldStatistics, newStatistics);
    ...
    public void setStatistics(StatisticsContainer newStatistics) {
		if (newStatistics != statistics) {
			...
			if (statistics != null)
				msgs = ((InternalEObject)statistics).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ClickWatchDataModelPackage.MODEL_ELEMENT_WITH_STATISTICS__STATISTICS, null, msgs);
			if (newStatistics != null)
				msgs = ((InternalEObject)newStatistics).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ClickWatchDataModelPackage.MODEL_ELEMENT_WITH_STATISTICS__STATISTICS, null, msgs);
			msgs = basicSetStatistics(newStatistics, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClickWatchDataModelPackage.MODEL_ELEMENT_WITH_STATISTICS__STATISTICS, newStatistics, newStatistics));
	}
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ClickWatchDataModelPackage.MODEL_ELEMENT_WITH_STATISTICS__STATISTICS:
