 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.datamodel.impl.ElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.hub.clickwatch.datamodel.impl.ElementImpl#getHandlers <em>Handlers</em>}</li>
 *   <li>{@link de.hub.clickwatch.datamodel.impl.ElementImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ElementImpl extends TraceableImpl implements Element {
	...
	protected EClass eStaticClass() {
		return ClickWatchDataModelPackage.Literals.ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClickWatchDataModelPackage.ELEMENT__NAME, oldName, name));
	}
	...
	public EList<Handler> getHandlers() {
		if (handlers == null) {
			handlers = new EObjectContainmentEList<Handler>(Handler.class, this, ClickWatchDataModelPackage.ELEMENT__HANDLERS);
		}
		return handlers;
	}
	...
	public EList<Element> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<Element>(Element.class, this, ClickWatchDataModelPackage.ELEMENT__CHILDREN);
		}
		return children;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ClickWatchDataModelPackage.ELEMENT__HANDLERS:
				return ((InternalEList<?>)getHandlers()).basicRemove(otherEnd, msgs);
			case ClickWatchDataModelPackage.ELEMENT__CHILDREN:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClickWatchDataModelPackage.ELEMENT__NAME:
				return getName();
			case ClickWatchDataModelPackage.ELEMENT__HANDLERS:
				return getHandlers();
			case ClickWatchDataModelPackage.ELEMENT__CHILDREN:
