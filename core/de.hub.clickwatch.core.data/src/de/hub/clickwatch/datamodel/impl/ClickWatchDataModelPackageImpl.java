 ...
 * @generated
 */
public class ClickWatchDataModelPackageImpl extends EPackageImpl implements ClickWatchDataModelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see de.hub.clickwatch.datamodel.ClickWatchDataModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ClickWatchDataModelPackageImpl() {
		super(eNS_URI, ClickWatchDataModelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ClickWatchDataModelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ClickWatchDataModelPackage init() {
		if (isInited) return (ClickWatchDataModelPackage)EPackage.Registry.INSTANCE.getEPackage(ClickWatchDataModelPackage.eNS_URI);

		// Obtain or create and register package
		ClickWatchDataModelPackageImpl theClickWatchDataModelPackage = (ClickWatchDataModelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ClickWatchDataModelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ClickWatchDataModelPackageImpl());
		...
		theClickWatchDataModelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theClickWatchDataModelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ClickWatchDataModelPackage.eNS_URI, theClickWatchDataModelPackage);
		return theClickWatchDataModelPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getHandler_Values() {
	 ...
	 * @generated
	 */
	public ClickWatchDataModelFactory getClickWatchDataModelFactory() {
		return (ClickWatchDataModelFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(handlerEClass, HANDLER__VALUES);
	...
	public void initializePackageContents() {
		...
		initEReference(getHandler_Values(), this.getValue(), null, "values", null, 0, -1, Handler.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
...
} //ClickWatchDataModelPackageImpl
