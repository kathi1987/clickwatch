 ...
 * <ul>
 *   <li>{@link de.hub.clickwatch.datamodel.Node#getINetAddress <em>INet Address</em>}</li>
 *   <li>{@link de.hub.clickwatch.datamodel.Node#getPort <em>Port</em>}</li>
 *   <li>{@link de.hub.clickwatch.datamodel.Node#getBackbone <em>Backbone</em>}</li>
 *   <li>{@link de.hub.clickwatch.datamodel.Node#getConnection <em>Connection</em>}</li>
 *   <li>{@link de.hub.clickwatch.datamodel.Node#isRetrieving <em>Retrieving</em>}</li>
 *   <li>{@link de.hub.clickwatch.datamodel.Node#isListening <em>Listening</em>}</li>
 *   <li>{@link de.hub.clickwatch.datamodel.Node#isRecording <em>Recording</em>}</li>
 *   <li>{@link de.hub.clickwatch.datamodel.Node#getErrors <em>Errors</em>}</li>
 *   <li>{@link de.hub.clickwatch.datamodel.Node#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hub.clickwatch.datamodel.ClickWatchDataModelPackage#getNode()
 * @model
 * @generated
 */
public interface Node extends ModelElementWithStatistics {
	 ...
	 * @see de.hub.clickwatch.datamodel.ClickWatchDataModelPackage#getNode_INetAddress()
	...
	/**
	 * Sets the value of the '{@link de.hub.clickwatch.datamodel.Node#getINetAddress <em>INet Address</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setPort(String)
	 * @see de.hub.clickwatch.datamodel.ClickWatchDataModelPackage#getNode_Port()
	 * @model default="7777"
	 * @generated
	 */
	String getPort();
	...
	/**
	 * Sets the value of the '{@link de.hub.clickwatch.datamodel.Node#getPort <em>Port</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.hub.clickwatch.datamodel.ClickWatchDataModelPackage#getNode_Elements()
	 ...
	 * @see de.hub.clickwatch.datamodel.ClickWatchDataModelPackage#getNode_Connection()
	 * @model dataType="de.hub.clickwatch.datamodel.INodeConnection" transient="true"
	 * @generated
	 */
	INodeConnection getConnection();

	/**
	 * Sets the value of the '{@link de.hub.clickwatch.datamodel.Node#getConnection <em>Connection</em>}' attribute.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see de.hub.clickwatch.datamodel.ClickWatchDataModelPackage#getNode_Retrieving()
    ...
    /**
	 * Sets the value of the '{@link de.hub.clickwatch.datamodel.Node#isRetrieving <em>Retrieving</em>}' attribute.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see de.hub.clickwatch.datamodel.ClickWatchDataModelPackage#getNode_Listening()
	 * @model transient="true"
	 * @generated
	 */
    boolean isListening();
    ...
    /**
	 * Sets the value of the '{@link de.hub.clickwatch.datamodel.Node#isListening <em>Listening</em>}' attribute.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see de.hub.clickwatch.datamodel.ClickWatchDataModelPackage#getNode_Recording()
	 * @model transient="true"
	 * @generated
	 */
    boolean isRecording();
    ...
    /**
	 * Sets the value of the '{@link de.hub.clickwatch.datamodel.Node#isRecording <em>Recording</em>}' attribute.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link de.hub.clickwatch.datamodel.BackboneType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.hub.clickwatch.datamodel.ClickWatchDataModelPackage#getNode_Backbone()
	...
	/**
	 * Sets the value of the '{@link de.hub.clickwatch.datamodel.Node#getBackbone <em>Backbone</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link de.hub.clickwatch.datamodel.ClickWatchError}.
	 * <!-- begin-user-doc -->
     * <p>
	 ...
	 * @see de.hub.clickwatch.datamodel.ClickWatchDataModelPackage#getNode_Errors()
