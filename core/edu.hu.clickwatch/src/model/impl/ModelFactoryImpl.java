...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
	...
	public static ModelFactory init() {
		try {
			ModelFactory theModelFactory = (ModelFactory)EPackage.Registry.INSTANCE.getEFactory("edu.hu.clickwatch.model"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ModelPackage.NODE: return (EObject)createNode();
			case ModelPackage.ELEMENT: return (EObject)createElement();
			case ModelPackage.HANDLER: return (EObject)createHandler();
			case ModelPackage.NETWORK: return (EObject)createNetwork();
			case ModelPackage.MULTI_NODE: return (EObject)createMultiNode();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case ModelPackage.BACKBONE_TYPE:
