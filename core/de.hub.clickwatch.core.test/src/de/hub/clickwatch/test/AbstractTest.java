...
//		binder.bind(IHandlerAdapter.class).to(getHandlerAdapterClass());
...
//		binder.bind(Boolean.class).annotatedWith(Names.named(ClickWatchModule.B_COMPOUND_HANDLER_COMPRESSION)).toInstance(false);
	...
	protected Class<? extends IHandlerEventAdapter> getHandlerAdapterClass() {
//		return HandlerEventAdapter.class;
		return null;
	}
