...
import de.hub.clickwatch.test.internal.XmlModelRepositoryTest;
...
public class ClickSocketXSDDummy extends ClickSocketTestImpl {
	...
	private void initialize() {
		if (handlerXml == null) {
			...
			EObject model = EmfXmlUtil.deserializeModel(metaModel, readEntry(getDummyXmlEntry()));
			...
			for (EObject handler: handlers.eContents()) {
				...
				String serializedHandlerValue = EmfXmlUtil.serializeModel(metaModel, documentRoot);
