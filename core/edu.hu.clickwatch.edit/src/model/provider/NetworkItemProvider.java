...
public class NetworkItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.NETWORK__ELEMENT_FILTER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.NETWORK__HANDLER_FILTER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.NETWORK__UPDATE_INTERVALL,
				 true,
				 false,
				 false,
	...
	protected void addTimeoutPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Network_timeout_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Network_timeout_feature", "_UI_Network_type"),
				 ModelPackage.Literals.NETWORK__TIMEOUT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.NETWORK__NODES);
			childrenFeatures.add(ModelPackage.Literals.NETWORK__ALL);
			childrenFeatures.add(ModelPackage.Literals.NETWORK__SUBNETWORKS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Network.class)) {
			...
			case ModelPackage.NETWORK__ELEMENT_FILTER:
			case ModelPackage.NETWORK__HANDLER_FILTER:
			case ModelPackage.NETWORK__UPDATE_INTERVALL:
			case ModelPackage.NETWORK__TIMEOUT:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case ModelPackage.NETWORK__NODES:
			case ModelPackage.NETWORK__ALL:
			case ModelPackage.NETWORK__SUBNETWORKS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.NETWORK__NODES,
				 ModelFactory.eINSTANCE.createNode()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.NETWORK__NODES,
				 ModelFactory.eINSTANCE.createMultiNode()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.NETWORK__ALL,
				 ModelFactory.eINSTANCE.createMultiNode()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.NETWORK__SUBNETWORKS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ModelPackage.Literals.NETWORK__NODES ||
			childFeature == ModelPackage.Literals.NETWORK__ALL;
