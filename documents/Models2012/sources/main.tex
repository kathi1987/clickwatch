...
%\author{Markus Scheidgen, Anatolij Zubow, Joachim Fischer}
%\authorrunning{M. Scheidgen, A. Zubow, J. Fischer}
%\institute{Department of Computer Science, Humboldt Universit‰t zu Berlin\\
%           Unter den Linden 6, 10099 Berlin, Germany\\
%           \email{\{scheidge,zubow,fischer\}@informatik.hu-berlin.de}}

\author{Markus Scheidgen\inst{1} \and Anatolij Zubow\inst{1}
Joachim Fischer\inst{1} \and Thomas H. Kolbe\inst{2}}

\institute{Humboldt Universit‰t zu Berlin, Department of Computer Science\\%, Unter den Linden 6, 10099 Berlin, Germany\\
\email{\{scheidge,zubow,fischer\}@informatik.hu-berlin.de}
\and
Technical University Berlin,
Institute for Geodesy and Geoinformation Science\\%,
%Straﬂe des 17. Juni 135, 10623 Berlin, Germany\\
\email{thomas.kolbe@tu-berlin.de}}
