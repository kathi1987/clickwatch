...
\caption{Measure for liner parsing performance of EMF and logarithmic access performance of HBase.\markus{The dots in the EMF chart refer to different object sizes. either explain or remove.}}
