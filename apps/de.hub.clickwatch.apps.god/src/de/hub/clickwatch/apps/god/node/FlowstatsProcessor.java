...
public class FlowstatsProcessor implements NodeInformationProcessor {
	...
	public List<ClientInformations> handleGenuineInformations(String xmlData) {
		System.err.println("<" + this.getClass().getName() + "> handleGenuineInformations is not supported in FlowstatsProcessor");
		return null;
	}
