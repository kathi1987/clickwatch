...
public class HwBusyAndPdrPlotAnalysis implements IClickWatchMain {
	...
	public void main(IClickWatchContext ctx) {
		...
		final NumericalResult result = ctx.getAdapter(IResultsProvider.class).getResults().createNewNumericalResult("HwBusyPlotAnalysis");
	...
	private <HC> void plot(String nodeId, String handlerId, IPlotConfig<HC> config) {
		Iterator<Handler> iterator = dbUtil.getHandlerIterator(dbUtil.createHandle(record, 
